...
ocamlbuild -use-ocamlfind -j 4 -I ClessParser prism2SPT.native StochasticPetriNet.cmo modelConvert.native parserUnparseAttribute.native modelConvert.byte testSimulink.native
#cd _build
