...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_53 = Integer(53)#!env sage
...
if len(sys.argv)>_sage_const_5 :
    objregexp=re.compile(sys.argv[_sage_const_5 ])
...
def printGRML_arc(translist):
    ...
    for i in range(len(translist)):
        for j in  range(len(translist[i])):
            ...
            s+=printGRML_OneArc('8%d'%(idtrans[i][j]) , '6%d' %(idtrans[i][j]), '1%d' %(translist[i][j][_sage_const_4 ][_sage_const_0 ][_sage_const_0 ]));
            if ( finstate[translist[i][j][_sage_const_4 ][_sage_const_0 ][_sage_const_0 ]]) :
...
def printGRML_place(translist):
    s="";
    s+= printGRML_OnePlace('9','TargetState',_sage_const_0 );
    for i in range(len(translist)):
        s+= printGRML_OnePlace('1%d' %i,'s_%d_' %i, (i==_sage_const_0 ) );
        for j in  range(len(translist[i])):
            s+= printGRML_OnePlace('2%d' %(idtrans[i][j]),'s_%d' %i +'_%d' %j, _sage_const_0  );
    return(s);
    ...
    for i in range(len(translist)):
        for j in  range(len(translist[i])):
            ...
            if(isIsotropic):
                ...
                s+='        <attribute name="expr"><attribute name=\"unParsed\">'+ poly_to_c_bis(quadriple[_sage_const_3 ][i][j]) +'</attribute></attribute>\n';
                s+='      </attribute>\n'
                s+='      <attribute name="param">\n'
                s+='        <attribute name="expr"><attribute name=\"unParsed\">'+ poly_to_c_bis(quadriple[_sage_const_4 ][i][j]) +'</attribute></attribute>\n';
                s+='      </attribute>\n'
            else:
                s+='      <attribute name="param">\n'
            ...
            for c in range(cardclocks):
                if translist[i][j][_sage_const_4 ][_sage_const_0 ][c+_sage_const_1 ]==_sage_const_0 :
