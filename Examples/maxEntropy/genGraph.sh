...
sage script_tocosmos.sage $1 $1.grml 10 -unif fldsjflds

Cosmos $1.grml --loop "#400000" --trace-place "x_1,x_2,x_3" --output-trace $1.dat 0.0 --max-run 1
...
#exit 0
Cosmos Iso_$1.grml --loop "#400000" --trace-place "x_1,x_2,x_3" --output-trace Iso_$1.dat 0.0 --max-run 1
