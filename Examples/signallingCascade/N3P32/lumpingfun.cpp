...
const int reducePL_RE_ERKP_Phase3 = 9;
const int reducePL_RE_ERKP_MEKPP = 10;
const int reducePL_RE_MEK = 11;
...
void SPN::lumpingFun(const abstractMarking &Marking,vector<int> &vect){
	...
	//tock = 2*N2;
	vect[reducePL_RE_MEK_RafP] = min(6,Marking.P->_PL_MEK_RafP);
	vect[reducePL_RE_MEK] = Marking.P->_PL_MEK + Marking.P->_PL_MEK_RafP - vect[reducePL_RE_MEK_RafP];
	
	vect[reducePL_RE_MEKP_RafP] = min(6 - vect[reducePL_RE_MEK_RafP] , Marking.P->_PL_MEKP_RafP); //To Complete
	...
	tock = max(0,6 - vect[reducePL_RE_MEK_RafP] - vect[reducePL_RE_MEKP_RafP]);
	vect[reducePL_RE_RafP] = remaining1(Marking.P->_PL_RafP,6);// + Marking.P->_PL_RafP_Phase1;
