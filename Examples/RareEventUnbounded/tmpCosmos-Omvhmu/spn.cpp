...
switch (t){
	case 0:	//rho_0
	{
		ParamDistr[0]= ( double )  /*Constant*/rho0 ;
	}

		break;
	default:	//rho_1,rho_2,
	{
		ParamDistr[0]= ( double )  /*Constant*/rho1 ;
	}
