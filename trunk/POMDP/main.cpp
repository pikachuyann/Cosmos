...
int main(int argc, char** argv) {
	...
	string Cosmoscmd = "Cosmos generated.gspn generated.lha --njob 12 -d test --max-run 50000 --batch 100 --count-transition --width 0.01 -v 1 --gppcmd clang++ --gppflags -Wno-return-type --tmp-status 2";
