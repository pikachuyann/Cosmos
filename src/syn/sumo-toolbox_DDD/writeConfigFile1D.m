function filename=writeConfigFile1D(numInitSamples, numTotalSamples, experimentName)
content = {...
...
filename=strcat('config/oneparam_',experimentName,'.xml');
