% > @file "@TPLatinHypercubeDesign/TPLatinHypercubeDesign.m"
...
% > Signature
% >	TPLatinHypercubeDesign
% 
%  ======================================================================
% > @brief Choose an initial sampleset in such a way that they form a latin
% >	hypercube. The Translational Propagational algorithm by Viana is used
% >   to approximate the optimal latin hypercube.
% >
% >  Viana, Felipe AC, Gerhard Venter, and Vladimir Balabanov.
% >  "An algorithm for fast optimal Latin hypercube design of experiments."
% >  International journal for numerical methods in engineering 82.2 (2010): 135-156.
% >
