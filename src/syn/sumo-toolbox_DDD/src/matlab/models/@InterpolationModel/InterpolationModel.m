% > @file "@InterpolationModel/InterpolationModel.m"
...
% 
%  ======================================================================
% > @brief Constructs an interpolation based on Matlabs griddata (to allow for
% >	scattered data).
% >
% > For 1D data the interp1 command is used.  For more
