function filename=writeConfigFile2D(numInitSamples, numTotalSamples, experimentName)
content = {...
...
'		<Run name="#simulator#_ei" repeat="1">';...
'		</Run>';...
'	</Plan>';...
'	<!-- /////////////////////////////////////////////////////////////////////// -->';...
'	<!-- General configuration section -->';...
'	<ContextConfig id="default">';...
strcat('		<OutputDirectory>output_',experimentName,'</OutputDirectory>');...
'		<PlotOptions>';...
...
'			<Option key="keepOldModels" value="on"/>';...
'		</PlotOptions>';...
'		<Profiling>';...
...
strcat('        <Option key="maximumTotalSamples" value="',sprintf('%d',numTotalSamples),'"/>');...
...
'		<Option key="maxResubmissions" value="10"/>';...
...
strcat('		<Option key="points" value="',sprintf('%d',numInitSamples),'"/>');...
'	</InitialDesign>';...
'</ToolboxConfiguration>'};

filename=strcat('config/twoparams_',experimentName,'.xml');
